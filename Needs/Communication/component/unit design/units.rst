...
one file per module, not one file per unit. Add new units here as
additional ``.. unit::`` directives.
...
.. note::
   ...
   src/communication/serializer.c``) to confirm it builds and the
   round-trip/truncation/empty-payload assertions pass.
