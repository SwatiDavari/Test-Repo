...
``release_notes/``, ``errata/`` — see ``doc/README.md``); as of
2026-08-21 ``release_notes/`` is real, built Sphinx content
(``myst_parser`` registered for the Markdown release notes), not plain
unbuilt Markdown as before.
