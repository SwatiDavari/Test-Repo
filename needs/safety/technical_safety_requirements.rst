...
Register of Technical Safety Requirement (``tsr``) needs, decomposed
from the functional safety requirements in
:doc:`functional_safety_requirements` — new TSRs are added here, not as
new files.
