...
.. note::
   ...
   ``org_governance/iso26262/org_fusa_requirements.rst`` (ISO 26262
   organizational safety content, byte-identical) — clearly the wrong
   standard for a file under ``org_verification/iso29119/``. Replaced
...
.. org_req:: Organizational test strategy
   ...
   strategy (see ``test/test-strategy/``).
