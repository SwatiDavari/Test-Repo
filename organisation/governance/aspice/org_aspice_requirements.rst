Automotive SPICE — Organizational Process Model Requirements
=====================================================================
...
.. note::
   Quality assurance (SUP.1), capability level policy, appraisal
   program, competence, tailoring, and the safety/cybersecurity
   interface requirements previously listed here have moved to
   :doc:`../quality/org_quality_requirements`, which derives from
   ``ORG_ASPICE_PRM_001`` below. This file now holds only the PAM
