...
:doc:`../../../organisation/tools/tool_qualification_requirements` for tool
...
way :doc:`../../../organisation/tools/tool_qualification_requirements` decomposes
...
.. org_req:: Infrastructure requirements are defined (outcome a)
   ...
   :doc:`../../../organisation/tools/tool_register`); docs hosting must serve static
...
.. org_req:: Infrastructure elements are identified and specified (outcome b)
   ...
   **Satisfied** — see :doc:`infra_register`, migrated the same way
   :doc:`../../../organisation/tools/tool_register` was: real elements, not invented
   ones.
...
.. org_req:: Business opportunities and investments are qualified and prioritized (outcome a)
   ...
   **Partial, disclosed rather than closed here:** :doc:`../../../organisation/strategy/strategy`
   (vision, business objectives, engineering principles) and
   :doc:`../../../organisation/strategy/roadmap` (platform-evolution phases) describe
